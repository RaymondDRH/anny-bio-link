  ...
  return enviarCorreo(
    {
      from: 'Anny Gómez <ventas@annygomez.com>',
      to: [toEmail],
      subject: '✈️ Recibimos tu primera parte — aquí completas la segunda',
